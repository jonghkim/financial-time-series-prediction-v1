...
![visual_task](supplementary/visual_task.png){: width="50%" height="50%"}{: .center}
...
![GoogleNet](supplementary/googlenet.png){: width="50%" height="50%"}{: .center}
![InceptionNet](supplementary/inceptionnet.png){: width="50%" height="50%"}{: .center}
...
![ResNet](supplementary/res.png){: width="50%" height="50%"}{: .center}
![ResNeXt](supplementary/resnetxt.png){: width="50%" height="50%"}{: .center}
...
![YOLO](supplementary/yolo.png){: width="50%" height="50%"}{: .center}
...
![SegNet](supplementary/segnet.png){: width="50%" height="50%"}{: .center}
...
![WaveNet](supplementary/wavenet.gif){: width="50%" height="50%"}{: .center}
...
![LipReading](supplementary/lipreading.jpeg){: width="50%" height="50%"}{: .center}
![LipReadingExample](supplementary/lipreading_example.gif){: width="50%" height="50%"}{: .center}

    - Lip Sync from Audio
        - Combination of models
        1. RNN 2. Mouth Syntyhesis 3. Re-timing 4. Composite 

![lipsync](supplementary/lipsync.png){: width="50%" height="50%"}{: .center}
